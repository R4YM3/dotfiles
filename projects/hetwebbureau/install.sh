...
git clone https://github.com/R4YM3/web-cli-shell.git "$HETWEBBUREAU_DIR/web-cli-shell"
install_tmuxinator_project "$HETWEBBUREAU_DIR/web-cli-shell/tmuxinator.yml" "web-cli-shell.yml"
