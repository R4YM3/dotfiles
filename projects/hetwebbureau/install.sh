...
git clone https://github.com/R4YM3/dotfiles-ansible.git $HETWEBBUREAU_DIR/dotfiles-ansible
install_tmuxinator_project "$HETWEBBUREAU_DIR/dotfiles-ansible/tmuxinator.yml" "dotfiles-ansible.yml"
